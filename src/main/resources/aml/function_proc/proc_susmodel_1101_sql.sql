   ...
   where date_id = v_dt_date and suspcs_model_code = '1101';
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1101') like '%80001%';
        ...
        inner join (select * from Aml_Blacklist where id_num is not null or id_num <> '') ab3
         ...
         and ab3.status = '1' and ab3.back_flag = '1'
        where 1 = (select enable from aml_stcr where featurecode = '80002')
       and (select featureCodes from aml_susmodel where susModelCode = '1101') like '%80002%';
        ...
        inner join (select * from Aml_Blacklist where id_num is not null or id_num <> '') ab4
         ...
         and ab4.status = '1' and ab4.back_flag = '1'
         where 1 = (select enable from aml_stcr where featurecode = '80003')
       and (select featureCodes from aml_susmodel where susModelCode = '1101') like '%80003%';
        ...
        inner join (select * from Aml_Blacklist where id_num is not null or id_num <> '') ab5
         ...
         and ab5.status = '1' and ab5.back_flag = '1'
        where 1 = (select enable from aml_stcr where featurecode = '80004')
       ...
       inner join (select * from Aml_Blacklist where id_num is not null or id_num <> '') ab6
         ...
         and ab6.status = '1' and ab6.back_flag = '1'
        where 1 = (select enable from aml_stcr where featurecode = '80005')
       ...
       inner join (select * from Aml_Blacklist where id_num is not null or id_num <> '') ab7
         ...
         and ab7.status = '1' and ab7.back_flag = '1'
        left join aml_stcr ams on ams.featureCode = '80006'
        where 1 = (select enable from aml_stcr where featurecode = '80006')
       ...
       inner join (select * from Aml_Blacklist where customer_name is not null or customer_name <> '') ab3
         ...
         and ab3.status = '1' and ab3.back_flag = '1'
       where 1 = (select enable from aml_stcr where featurecode = '80008')
       and (select featureCodes from aml_susmodel where susModelCode = '1101') like '%80008%';
        ...
        inner join (select * from Aml_Blacklist where customer_name is not null or customer_name <> '') ab4
         ...
         and ab4.status = '1' and ab4.back_flag = '1'
        where 1 = (select enable from aml_stcr where featurecode = '80009')
       ...
       inner join (select * from Aml_Blacklist where customer_name is not null or customer_name <> '') ab5
         ...
         and ab5.status = '1' and ab5.back_flag = '1'
        where 1 = (select enable from aml_stcr where featurecode = '80010')
       and (select featureCodes from aml_susmodel where susModelCode = '1101') like '%800010%';
       ...
       inner join (select * from Aml_Blacklist where customer_name is not null or customer_name <> '') ab6
         ...
         and ab6.status = '1' and ab6.back_flag = '1'
        where 1 = (select enable from aml_stcr where featurecode = '80011')
       and (select featureCodes from aml_susmodel where susModelCode = '1101') like '%80011%';
        ...
        inner join (select * from Aml_Blacklist where customer_name is not null or customer_name <> '') ab7
         ...
         and ab7.status = '1' and ab7.back_flag = '1'
        where 1 = (select enable from aml_stcr where featurecode = '80012')
	...
	create table aml_func_dist_str_tmp01(str1 varchar(2000));
		-- 汇总可疑特征码
	select func_dist_str(GROUP_CONCAT(distinct stcr),',') into v_stcr from aml_suspcs_case_detail where date_id = v_dt_date and suspcs_model_code = '1101';
	-- 汇总涉嫌犯罪类型
	select func_dist_str(GROUP_CONCAT(distinct tosc),',') into v_tosc from aml_suspcs_case_detail where date_id = v_dt_date and suspcs_model_code = '1101';
	-- 汇总资金交易行为情况
	select concat('交易总笔数',COUNT(1),'笔,交易金额',sum(trans_amount),'元') into v_stcb from aml_suspcs_case_detail where date_id = v_dt_date and suspcs_model_code = '1101';
	-- 汇总疑点分析
	select func_dist_str(GROUP_CONCAT(distinct aosp),',') into v_aosp from aml_suspcs_case_detail where date_id = v_dt_date and suspcs_model_code = '1101';	
