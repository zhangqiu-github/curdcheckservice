  ...
  select case when count(1) = 0 then 
   ...
   where date_id = v_dt_date and suspcs_model_code = '1106';
	 ...
	 select atr.trans_code trans_code, -- 交易流水编号
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80501%';
	 ...
	 select atr.trans_code trans_code, -- 交易流水编号
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80502%';
      ...
      -- 对公股东证件
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80503%';
      ...
      insert into aml_foreign_dignitaries_trans
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80504%';
     ...
     insert into aml_foreign_dignitaries_trans
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80505%';
      ...
      insert into aml_foreign_dignitaries_trans
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80506%';
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80507%';
      ...
      -- 对公法人姓名
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80508%';
      ...
      -- 对公股东姓名
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80509%';
      ...
      -- 对公受益人姓名
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80510%';
      ...
      select atr.trans_code trans_code, -- 交易流水编号
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80511%';
      ...
      select atr.trans_code trans_code, -- 交易流水编号
       ...
       and (select featureCodes from aml_susmodel where susModelCode = '1106') like '%80512%';
