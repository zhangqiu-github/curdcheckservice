...
@Repository
public class SelectByConditionDao extends BaseDao{

	public List<Map<String,Object>> query(String strProjectCode,String datasourceName,String tableName,String sql,Object[] args){
		...
		return jdbcTemplate.query(sql,args,new RowMapper<Map<String,Object>>(){
			public Map<String, Object> mapRow(ResultSet arg0, int arg1) throws SQLException {
				...
				if(entityTable != null){
					for(int i=0;i<columnCount;i++){
						//ORACLE分页查询时arg0.getMetaData().getColumnName(i + 1)存在字段null
					...
					for(int i=0;i<columnCount;i++){
						if(arg0.getMetaData().getColumnName(i + 1) != null){
	...
	public int queryForInt(String strProjectCode,String datasourceName,String tableName,String sql,Object[] args){
		JdbcTemplate jdbcTemplate = getJdbcTemplate(strProjectCode,datasourceName);
