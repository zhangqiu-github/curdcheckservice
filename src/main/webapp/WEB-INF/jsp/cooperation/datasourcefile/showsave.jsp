    ...
    <form name="form" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <p id="buttons">
                ...
                <input id="submit" type="submit" tabindex="4" value="删除数据源文件" onclick="deleteclick()">
                <input id="submit" type="submit" tabindex="4" value="初始化项目表" onclick="inittableclick()">
                <input id="submit" type="submit" tabindex="4" value="提交" onclick="submitclick()">
            </p>
        </fieldset>
    </form>
</body>
